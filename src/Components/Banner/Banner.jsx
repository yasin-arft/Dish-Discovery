      ...
      style={{ backgroundImage: 'url(https://i.ibb.co/HpbRy6H/banner.png)' }}>
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-4xl py-32">
            <h1 className="mb-4 text-5xl font-bold">Discover an exceptional cooking class tailored for you!</h1>
            <p className="mb-8 text-lg">Learn and Master Basic Programming, Data Structures, Algorithm, OOP, Database and solve 500+ coding problems to become an exceptionally well world-class Programmer.</p>
